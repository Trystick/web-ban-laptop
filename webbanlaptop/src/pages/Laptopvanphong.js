...
function Laptopvanphong(props) {
    return (
        ...
        <section className="product">
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/dell-xps-13-9380.png" />
            </a>
            <h1>Dell XPS 13 9380</h1>
            <p style={{color: 'red'}}><strong>35.500.000 ₫</strong></p>
            <ul className="button">
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/thinkpadX1carbonGen6.png" />
            </a>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/Yoga920.png" />
            </a>
            <h1>Lenovo Yoga 920</h1>
            <p style={{color: 'red'}}><strong>36.000.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
        ...
        <section className="product">
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/hpelitebook830.png" />
            </a>
            <h1>HP EliteBook 850 G6</h1>
            <p style={{color: 'red'}}><strong>23.900.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/asus-vivobook-a512-blue-1.png" />
            </a>
            <h1>Asus Vivobook A512FA-EJ837T (Blue)</h1>
            <p style={{color: 'red'}}><strong>12.350.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopVP/AcerAspireA515-53-5112.png" />
            </a>
            <h1>Asus Vivobook A512FA-EJ837T (Blue)</h1>
            <p style={{color: 'red'}}><strong>12.350.000 ₫</strong></p>
            <ul className="button">
