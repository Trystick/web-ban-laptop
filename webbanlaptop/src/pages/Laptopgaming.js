...
function Laptopgaming(props) {
    return (
        ...
        <section className="brand">
          <article><a href="#link" target="_blank"><img src="assets/img/brand/apple.png" style={{width: '20%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/microsoft.png" style={{width: '24%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/asus.png" style={{width: '85%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/acer.png" style={{width: '75%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/dell.png" style={{width: '24%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/lenovo.png" style={{width: '90%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/hp.png" style={{width: '25%'}} /></a></article>
          <article><a href="#link" target="_blank"><img src="assets/img/brand/msi.png" style={{width: '70%'}} /></a></article>
        </section>
        <section className="cost">
          <article><a href="#">Dưới 5 triệu</a></article>
          <article><a href="#">5 triệu đến 10 triệu</a></article>
          <article><a href="#">10 triệu đến 15 triệu</a></article>
          <article><a href="#">15 triệu đến 25 triệu</a></article>
          <article><a href="#">Trên 25 triệu</a></article>
        </section>
        ...
        <section className="product">
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/AsusTUF.png" />
            </a>
            <h1>Asus TUF FA506II-AL016T</h1>
            <p style={{color: 'red'}}><strong>23.990.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          </article>
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/4873_asus_rog_zephyrus_m_gu502gu_az089t__3_.png" />
            </a>
            <h1>Asus ROG Zephyrus M GU502GU-AZ089T</h1>
            <p style={{color: 'red'}}><strong>34.990.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/04-G532-Scar-Light_nowat-removebg-preview.png" />
            </a>
            <h1>Asus ROG Strix G531GT-AL007T</h1>
            <p style={{color: 'red'}}><strong>20.690.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/DellG7-7590.png" />
            </a>
            <h1>Dell Inspiron G7 7590-N7590Z</h1>
            <p style={{color: 'red'}}><strong>38.500.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/hp-pavilion-gaming-15-dk0001tx_1-removebg-preview.png" />
            </a>
            <h1>HP Pavilion Gaming 15-dk0000TX</h1>
            <p style={{color: 'red'}}><strong>23.890.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/5210_msi_gl65_leopard_10sdk_242vn_1-removebg-preview.png" />
            </a>
            <h1>MSI GL65 10SDK-242VN</h1>
            <p style={{color: 'red'}}><strong>33.490.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/520_P_1571821159538.png" />
            </a>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/triton-500-4-removebg-preview.png" />
            </a>
            <h1>Acer Predator Triton 500 PT515-51-73AA</h1>
            <p style={{color: 'red'}}><strong>45.990.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopGaming/gearvn-acer-nitro-5-2_cd6c5d77e5c249b783dda04b39312a06-removebg-preview.png" />
            </a>
            <h1>Acer Nitro AN515-54-76RK</h1>
            <p style={{color: 'red'}}><strong>25.990.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
        ...
        <center>
          <div className="button_num">
            <ul>
              <li>
                <a href="#"><button className="button-num" name="button" type="button">1</button></a>
              </li>
              <li>
                <a href="#"><button className="button-num" name="button" type="button">2</button></a>
              </li>
            </ul>
          </div>
        </center>
