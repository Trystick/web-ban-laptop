        ...
        <center>
          <div className="signupbox">
            ...
            <form onSubmit={this.handleSubmit}>
              <input type="hovaten" name="ten_khach_hang" onChange={this.handleChange} value={this.state.ten_khach_hang} placeholder="Họ và tên" />
              <input type="email" name="email" onChange={this.handleChange} value={this.state.email} placeholder="Email" />
              <input type="diachi" name="diachi" onChange={this.handleChange} value={this.state.diachi} placeholder="Địa chỉ" />
              <select name="province_id" className='province' required>
                <option value="provine">Tỉnh / Thành phố</option>
                {
                  items.map((item) => ( 
                  <option value= { item.name } key = { item.id } onChange={this.handleChange}>
                    { item.name }
                  </option>
                  ))
                }
              ...
              <input type="sdt" name="so_dien_thoai" value={this.state.so_dien_thoai}  onChange={this.handleChange} placeholder="Số điện thoại" />
              <input type="username" name="username" value={this.state.username}  onChange={this.handleChange} placeholder="Tên đăng nhập" />
              <input type="password" name="password" value={this.state.password}  onChange={this.handleChange}  placeholder="Mật khẩu" />
