...
function Linhkien(props) {
  ...
  <section className="brandpk">
    <article><a href="#link" target="_blank"><img src="assets/img/brand/adata.png" style={{width: '50%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/kingston.png" style={{width: '90%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/Intel.png" style={{width: '42%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/Crucial.png" style={{width: '90%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/gigabyte.png" style={{width: '100%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/samsung.png" style={{width: '95%'}} /></a></article>
    <article><a href="#link" target="_blank"><img src="assets/img/brand/SanDisk.png" style={{width: '90%'}} /></a></article>  
  </section>
  ...
  <section className="product">
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/linhkien/SSDKingstonA400240GB.png" />
      </a>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/linhkien/SSDCrucialBX500120GB.png" />
      </a>
      <h1>SSD Crucial BX500 3D NAND SATA III 120GB</h1>
      <p style={{color: 'red'}}><strong>640.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/linhkien/ssd-gigabyte-01.png" />
      </a>
      <h1>SSD Gigabyte 2.5-Inch SATA III 120GB</h1>
      <p style={{color: 'red'}}><strong>600.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/RAM/kvr-ddr4-2666-4gb-01.png" />
      </a>
      <h1>Ram Laptop Kingston DDR4 4GB Bus 2666</h1>
      <p style={{color: 'red'}}><strong>450.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/RAM/CrucialDDR42666_8GB - Copy.png" />
      </a>
      <h1>Ram Laptop Crucial DDR4 4GB Bus 2666</h1>
      <p style={{color: 'red'}}><strong>490.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/RAM/samsung_m471a1k43db1-cwe-01.png" />
      </a>
      <h1>Ram Laptop Samsung DDR4 8GB Bus 3200MHz</h1>
      <p style={{color: 'red'}}><strong>890.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/HDD/seagate-barracuda-3-5-1tb-1-removebg-preview.png" />
      </a>
      <h1>HDD Seagate BarraCuda 1TB 3.5 inch SATA III</h1>
      <p style={{color: 'red'}}><strong>1.000.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/HDD/wd10ezex-e3ac8513-5f2c-4593-821f-440263249073-removebg-preview.png" />
      </a>
    ...
    <article>
      <a href="#">
        <img style={{width: '70%'}} src="assets/img/HDD/wd-purple-1tb-removebg-preview.png" />
      </a>
      <h1>HDD WD Purple 1TB 3.5 inch SATA III </h1>
      <p style={{color: 'red'}}><strong>1.400.000 ₫</strong></p>
      <ul className="button">
        <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
        <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
      </ul>
