        ...
        <React.Fragment>
            <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <form>
                                    ...
                                    <i className="fas fa-search search" style={{ color: 'white', fontSize: 23 }} align="middle" />
                                </form>
                            </li>
                            <li>
                                <p>
                ...
                <marquee behavior="scroll" direction>
                    <p style={{ fontSize: 24 }}>
                        <strong>
                            <i className="fas fa-bullhorn" style={{ color: 'red', fontSize: 30 }} />
                            [TƯNG BỪNG KHAI TRƯƠNG] Giảm giá 20% trên tổng hoá đơn cho tất cả khách hàng từ ngày 01/06/2020 đến ngày 30/06/2020
                            <i className="fas fa-bullhorn" style={{ color: 'red', fontSize: 30 }} />
                        </strong>
                    </p>
                </marquee>

                <a href="chitietsanpham.html"><div className="background1" /></a>
                <a href="chitietsanpham.html"><div className="background2" /></a>
                ...
                <section>
                    <article>
                        <img src="assets/img/dell/xps132in1.png" style={{ width: '100%' }} />
                        <h3 style={{ fontFamily: '"Open Sans", sans-serif' }}>Dell XPS 13 2in1</h3>
                        <a href="chitietsanpham.html"><button className="button-btn" name="button" type="button">Xem Ngay</button></a>
                    </article>
                    <article>
                        <img src="assets/img/hp/hp-spectre.png" style={{ width: '100%' }} />
                        <h3 style={{ fontFamily: '"Open Sans", sans-serif' }}>Hp Spectre</h3>
                        <a href="chitietsanpham.html"><button className="button-btn" name="button" type="button">Xem Ngay</button></a>
                    </article>
                    <article>
                        <img src="assets/img/lenovo/X1carbonGen6.png" style={{ width: '100%' }} />
                        <h3 style={{ fontFamily: '"Open Sans", sans-serif' }}>Lenovo Thinkpad X1 Carbon 6th Gen</h3>
                        <a href="chitietsanpham.html"><button className="button-btn" name="button" type="button">Xem Ngay</button></a>
                    </article>
                </section>
                <section className="half-half">
                    <article>
                        <img src="assets/img/linhkien/ssd.jpg" style={{ width: '100%' }} />
                        <h3 style={{ fontFamily: '"Open Sans", sans-serif' }}>SSD cho tốc độ vượt trội</h3>
                        <a href="linhkien.html"><button className="button-btn" name="button" type="button">Nâng Cấp Ngay</button></a>
                    </article>
                    <article>
                        <img src="assets/img/linhkien/ram.jpg" style={{ width: '100%' }} />
                        <h3 style={{ fontFamily: '"Open Sans", sans-serif' }}>RAM càng nhiều xử lý càng nhanh!</h3>
                        <a href="linhkien.html"><button className="button-btn" name="button" type="button">Nâng Cấp Ngay</button></a>
                    </article>
                </section>
                <footer>
