    ...
    return (
        ...
        */}
        <section className="product">
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/dell-vostro-3590-i3-10110u-4gb-1tb-win10-v5i3505w-1-600x600-removebg-preview.png" />
            </a>
            <h1>Dell Vostro 3590</h1>
            <p style={{color: 'red'}}><strong>20.990.000 ₫</strong></p>
            <ul className="button">
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/dell-inspiron-5593-i5-1035g1-8gb-256gb-2gb-mx230-w-1-600x600-removebg-preview.png" />
            </a>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/asus-vivobook-x509fj-i3-8145u-4gb-1tb-2gb-mx230-wi-1-600x600-removebg-preview.png" />
            </a>
            <h1>Asus VivoBook X509FJ</h1>
            <p style={{color: 'red'}}><strong>18.990.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/lenovo-ideapad-l340-15irh-i7-9750h-8gb-1tb-3gb-gtx-17-600x600.png" />
            </a>
            <h1>Lenovo IdeaPad L340 15IRH</h1>
            <p style={{color: 'red'}}><strong>21.290.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/acer-swift-sf315-52g-87n4-i7-8550u-8gb-128gb-2gb-m-16-600x600.png" />
            </a>
            <h1>Acer Swift 3 SF315 52G 87N4</h1>
            <p style={{color: 'red'}}><strong>23.590.000 ₫</strong></p>
            <ul className="button">
              <li><a href="#"><button className="button-btn" name="button" type="button">Xem ngay</button></a></li>
              <li><a href="#"><button className="button-btn" name="button" type="button"><i className="fas fa-cart-plus" /></button></a></li>
            </ul>
          ...
          <article>
            <a href="#">
              <img style={{width: '70%'}} src="assets/img/LaptopDoHoaKyThuat/asus-ux333fn-a4124t-19-600x600-removebg-preview.png" />
            </a>
